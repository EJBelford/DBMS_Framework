...
----*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--
--         NAME: tr_i_atis_ictl_tasks 
--      PURPOSE: Insert trigger for atis_ictl_tasks 
--
--   CREATED BY: Gene Belford 
-- CREATED DATE: 2017-11-28 
--
--       SOURCE: tr_i_atis_ictl_tasks.sql 
--
--        NOTES:
--
-- 
...
CREATE OR REPLACE TRIGGER tr_i_atis_ictl_tasks_seq
BEFORE INSERT
ON atis_ictl_tasks
...
BEGIN
    ...
    SELECT atis_ictl_tasks_seq.nextval 
    INTO   v_rec_id 
    FROM   dual;
