/*--*----|----*----|----*----|---- TEAM ITSS ----*----|----|----*----|----*---*/
--
--         NAME: frz_pfsa_equip_avail_tmp 
--      PURPOSE: To calculate the desired information.
--
-- TABLE SOURCE: frz_pfsa_equip_avail_tmp.sql 
--
...
-- DROP TABLE frz_pfsa_equip_avail_tmp;
...
COMMENT ON TABLE frz_pfsa_equip_avail_tmp 
IS 'frz_pfsa_equip_avail_tmp - This table serves as the staging point for processing equip avail data.  Data is placed into the table from production amac, readiness as well as legacy (wolf) maintenance data processing';


COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.rec_id 
IS 'REC_ID - Primary, blind key of the pfsawh_item_sn_p_fact table.'; 

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.source_rec_id 
IS 'SOURCE_REC_ID - Identifier to the orginial record received from the outside source.'; 

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.pba_id 
IS 'PBA_ID - PFSAW identitier for a particular Performance Based Agreement.'; 
 
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.physical_item_id 
IS 'PHYSICAL_ITEM_ID - Foreign key of the PFSAWH_ITEM_DIM table.'; 

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.physical_item_sn_id 
IS 'PHYSICAL_ITEM_SN_ID - Foreign key of the PFSAWH_ITEM_SN_DIM table.'; 

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.force_unit_id 
IS 'FORCE_UNIT_ID - Foreign key of the PFSAWH_FORCE_UNIT_DIM table.'; 

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.mimosa_item_sn_id 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PFSA_ITEM_ID 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.RECORD_TYPE 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.FROM_DT 
IS 'FROM DATE - The beginning date for a historical record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.TO_DT 
IS 'TO DATE - The ending date for a historical record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.READY_DATE 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.DAY_DATE 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.MONTH_DATE 
IS 'MONTH_DATE - A truncated date value representing the entire month forward';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PFSA_ORG 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.SYS_EI_SN 
IS 'SERIAL NUMBER - A character field used to uniquely identify a specific item.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.ITEM_DAYS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.NMCM_INT_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.NMCM_DEP_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.NMCS_USER_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.NMCS_INT_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.NMCS_DEP_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PMCS_INT_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PMCM_USER_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PMCM_INT_HRS 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.DEP_HRS 
IS 'DEP_HRS - The total number of hours in a non mission capable status at the depot level.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.HEIR_ID 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.PRIORITY 
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.uic  
...
COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.status 
IS 'STATUS - The status of the record in question.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.FRZ_INPUT_DATE 
IS 'FRZ_INPUT_DATE - ';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.FRZ_INPUT_DATE_ID 
IS 'FRZ_INPUT_DATE_ID - ';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.rec_frz_flag 
IS 'REC_FRZ_FLAG - Flag indicating if the record is frozen or not.  Values: N - Not frozen, Y - Frozen';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.frz_date 
IS 'FRZ_DATE - Additional control for REC_FRZ_FLAG indicating when the record was frozen.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.delete_date 
IS 'DELETE_DATE - Additional control for DELETE_FLAG indicating when the record was marked for deletion.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.DELETE_by 
IS 'DELETE_BY - Reports who deleted the record.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.hidden_date 
IS 'HIDDEN_DATE - Addition control for HIDDEN_FLAG indicating when the record was hidden.';

COMMENT ON COLUMN frz_pfsa_equip_avail_tmp.HIDDEN_by 
...
-- WHERE  table_name = UPPER('frz_pfsa_equip_avail_tmp'); 
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('frz_pfsa_equip_avail_tmp') 
    AND  a.column_name = b.column_name
WHERE    a.table_name = UPPER('frz_pfsa_equip_avail_tmp') 
