DROP TABLE gb_pfsa_pba_metrics_ref; 
	
/*--*----|----*----|----*----|---- TEAM ITSS ----*----|----|----*----|----*---*/
--
--         NAME: gb_pfsa_pba_metrics_ref
--      PURPOSE: To calculate the desired information.
--
-- TABLE SOURCE: gb_pfsa_pba_metrics_ref.sql
--
...
--
--
CREATE TABLE gb_pfsa_pba_metrics_ref 
(
...
CONSTRAINT pk_gb_pfsa_pba_metrics_ref PRIMARY KEY 
    (
    metric_id
    )    
) 
...
DROP INDEX ixu_gb_pfsa_pba_metrics_ref;

CREATE UNIQUE INDEX ixu_gb_pfsa_pba_metrics_ref 
    ON gb_pfsa_pba_metrics_ref
    (
    rec_id
    );
...
ALTER TABLE gb_pfsa_pba_metrics_ref  
...
DROP SEQUENCE pfsa_pba_met_ref_seq;

CREATE SEQUENCE pfsa_pba_met_ref_seq
    START WITH 1000000
    MAXVALUE   9999999
    MINVALUE   1
    NOCYCLE
...
COMMENT ON TABLE gb_pfsa_pba_metrics_ref 
IS ''; 


COMMENT ON COLUMN gb_pfsa_pba_metrics_ref.rec_id 
IS ''; 

COMMENT ON COLUMN gb_pfsa_pba_metrics_ref.STATUS 
...
WHERE  table_name = UPPER('gb_pfsa_pba_metrics_ref'); 
...
LEFT OUTER JOIN user_tab_columns b  
    ON  b.table_name  = UPPER('gb_pfsa_pba_metrics_ref') 
    AND a.column_name = b.column_name
WHERE    a.table_name = UPPER('gb_pfsa_pba_metrics_ref') 
...
DECLARE
    ...
    CURSOR code_cur IS
        ...
        FROM gb_pfsa_pba_metrics_ref a
        ORDER BY a.catcode;
...
BEGIN 
    ...
    INSERT INTO gb_pfsa_pba_metrics_ref (perf_met_id, xx_code, xx_description) 
...
SELECT * FROM gb_pfsa_pba_metrics_ref; 
