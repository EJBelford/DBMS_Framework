/*--*----|----*----|----*----|---- TEAM ITSS ----|----*----|----*----|----*---*/
--
--         NAME: pfsawh_item_sn_dim 
--      PURPOSE: A major grouping End Items.  
--
-- TABLE SOURCE: pfsawh_item_sn_dim.sql 
--
...
ALTER TABLE pfsawh_item_sn_dim  
...
DROP INDEX idx_pfsawh_itmsn_dim_itmidsnid;        

CREATE INDEX  idx_pfsawh_itmsn_dim_itmidsnid 
    ON pfsawh_item_sn_dim 
    (
    physical_item_id,
    physical_item_sn_id     
...
DROP INDEX idx_pfsawh_itmsn_dim_niin_sn;        

CREATE INDEX  idx_pfsawh_itmsn_dim_niin_sn 
    ON pfsawh_item_sn_dim 
    (
    item_niin,
    item_serial_number     
...
DROP INDEX idx_pfsawh_itmsn_dim_sn;        

CREATE INDEX  idx_pfsawh_itmsn_dim_sn 
    ON pfsawh_item_sn_dim 
    (
    item_serial_number     
    );
...
COMMENT ON TABLE pfsawh_item_sn_dim 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.rec_id 
IS 'REC_ID - Sequence/identity for dimension.'; 

COMMENT ON COLUMN pfsawh_item_sn_dim.item_sn_id 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.physical_item_sn_id 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.mimosa_item_sn_id 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.item_location 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.item_location_id 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.item_uic 
IS 'ITEM_UIC - FORCE UIC - The unit identifier of valid Force UICs.'; 

COMMENT ON COLUMN pfsawh_item_sn_dim.item_force_id 
IS 'ITEM_FORCE_ID - FORCE UIC - The unit identifier of valid Force UICs as represented in the PFSAWH_FORCE_DIM.'; 

COMMENT ON COLUMN pfsawh_item_sn_dim.item_uic_location 
IS 'ITEM_UIC_LOCATION - Force location'; 

COMMENT ON COLUMN pfsawh_item_sn_dim.item_soc_flag 
IS 'ITEM_SOC_FLAG - Special Operations flag.'; 

COMMENT ON COLUMN pfsawh_item_sn_dim.item_acq_date 
...
COMMENT ON COLUMN pfsawh_item_sn_dim.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';
   
COMMENT ON COLUMN pfsawh_item_sn_dim.active_date 
IS 'ACTIVE_DATE - Additional control for active_Flag indicating when the record became active.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.INACTIVE_DATE 
IS 'INACTIVE_DATE - Additional control for active_Flag indicating when the record went inactive.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.INSERT_BY 
IS 'INSERT_BY - Reports who initially created the record.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.INSERT_DATE 
IS 'INSERT_DATE - Reports when the record was initially created.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.UPDATE_BY 
IS 'UPDATE_BY - Reports who last updated the record.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.UPDATE_DATE 
IS 'UPDATE_DATE - Reports when the record was last updated.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.DELETE_FLAG 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.DELETE_DATE 
IS 'DELETE_DATE - Additional control for DELETE_FLAG indicating when the record was marked for deletion.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.HIDDEN_FLAG 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';
    
COMMENT ON COLUMN pfsawh_item_sn_dim.HIDDEN_DATE 
...
WHERE  table_name = UPPER('pfsawh_item_sn_dim'); 
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('pfsawh_item_sn_dim') 
    AND a.column_name = b.column_name
WHERE a.table_name = UPPER('pfsawh_item_sn_dim') 
...
v_item_id                    pfsawh_item_sn_dim.item_id%TYPE     := '';
