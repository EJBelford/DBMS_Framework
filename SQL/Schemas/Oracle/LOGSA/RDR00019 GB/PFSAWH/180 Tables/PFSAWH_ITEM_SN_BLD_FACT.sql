...
--   
    ...
    item_force_unit_id               NUMBER           DEFAULT    0 ,
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_SYS_EI_NIIN    
IS 's_SYS_EI_NIIN - ';  

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_PFSA_ITEM_ID    
IS 's_PFSA_ITEM_ID - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_RECORD_TYPE    
IS 's_RECORD_TYPE - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_FROM_DT    
IS 's_FROM_DT - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_TO_DT    
IS 's_TO_DT - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_READY_DATE    
IS 's_READY_DATE - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_DAY_DATE    
IS 's_DAY_DATE - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_MONTH_DATE    
IS 's_MONTH_DATE - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_PFSA_ORG    
IS 's_PFSA_ORG - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_SYS_EI_SN    
IS 's_SYS_EI_SN - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_SOURCE_ID    
IS 's_SOURCE_ID - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_HEIR_ID    
IS 's_HEIR_ID - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_PRIORITY    
IS 's_PRIORITY - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.s_UIC    
IS 's_UIC - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.b_GRAB_STAMP    
IS 'b_GRAB_STAMP - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.b_PROC_STAMP    
IS 'b_PROC_STAMP - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.b_SYS_EI_UID    
IS 'b_SYS_EI_UID - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.PERIOD_TYPE 
IS 'PERIOD_TYPE - '; 
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.pba_id 
IS 'PBA_ID - .';
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_force_unit_id 
IS 'ITEM_FORCE_UNIT_ID - ';
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_uto_force_id 
IS 'ITEM_UTO_FORCE_ID - Theater Force - Foreign key of the ForceWH.UTO_FORCE_DIM table.';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_tfb_force_id 
IS 'ITEM_TFB_FORCE_ID - Custom - Foreign key of the ForceWH.TBF_FORCE_DIM table.';
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_usage_1 
IS 'ITEM_USAGE_1 - The actual usage of the system/end item accumulated during the period.';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_usage_type_1 
IS 'ITEM_USAGE_TYPE_1 - An indicator of the type of usage captured.';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_usage_2 
IS 'ITEM_USAGE_2 - The actual usage of the system/end item accumulated during the period.';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.item_usage_type_2 
IS 'ITEM_USAGE_TYPE_2 - An indicator of the type of usage captured.';
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.meantime_btwn_maint_act 
IS 'MEANTIME_BTWN_MAINT_ACT - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.meandown_time 
IS 'MEANDOWN_TIME - ';

COMMENT ON COLUMN pfsawh_item_sn_bld_fact.customer_wait_time 
...
COMMENT ON COLUMN pfsawh_item_sn_bld_fact.etl_processed_by 
...
ALTER TABLE pfsawh_item_sn_bld_fact  
    ADD CONSTRAINT pk_pfsawh_item_sn_bld_fact 
    PRIMARY KEY 
    (
    rec_id
    );    
