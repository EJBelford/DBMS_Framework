/*--*----|----*----|----*----|---- TEAM ITSS ----*----|----|----*----|----*---*/
--
--         NAME: frz_pfsa_supply_ilap_tmp 
--      PURPOSE: To calculate the desired information.
--
-- TABLE SOURCE: frz_pfsa_supply_ilap_tmp.sql 
--
...
-- 15MAY08 - GB  -          -      - Created 
-- 23JUN08 - GB  -          -      - Convert to frz_pfsa_supply_ilap_tmp from 
--                                       pfsa_supply_ilap 
--
/*--*----|----*----|----*----|---- TEAM ITSS ----*----|----|----*----|----*---*/

-- DROP TABLE frz_pfsa_supply_ilap_tmp;   

CREATE TABLE frz_pfsa_supply_ilap_tmp   
    (
...
COMMENT ON TABLE frz_pfsa_supply_ilap_tmp 
IS 'frz_pfsa_supply_ilap_tmp - '; 


COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.rec_id 
IS 'REC_ID - Sequence/identity for dimension/fact table.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.docno
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.ric_stor 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.ipg 
IS 'IPG - ISSUE PRIORITY GROUP - Priorities are grouped by 1 (01-03), 2 (04-08), and 3 (09-15).  '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.pniin 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.cwt 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_cust_iss 
IS 'D_CUST_ISS - Date of issue by customer'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.rcpt_docno 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.rcpt_dic 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_rcpt 
IS 'D_RCPT - Date of receipt by '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.rcpt_ric_fr 
IS 'RCPT_RIC_FR - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.pseudo 
IS 'PSEUDO - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.sof 
IS 'SOF - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.price 
IS 'PRICE - ESTIMATED REPAIR PART COST - The cost of each individual repair part used in a repair action.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.cat_sos 
IS 'CAT_SOS - SOS - Source Of Supply'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.sc 
IS 'SC - SUPPLY CLASS - A code that indicates the major category of materiel to which an item of supply is assigned.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.scmc 
IS 'SCMC - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.ami 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.dlr 
IS 'DLR - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.msc_spt 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.instl 
IS 'INSTL - INSTALLATION - This field specifies the installation for data aggregation.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.corps 
IS 'CORPS - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.macom 
IS 'MACOM - MAJOR ARMY COMMAND CODE (MACOM) - Identifies the Major Command or Department of the Army Staff Agency.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_upd 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.ssfcoc_flag 
IS 'SSFCOC_FLAG - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.component 
IS 'COMPONENT - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_docno 
IS 'D_DOCNO - Date of the Document Number.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_sarss1 
IS 'D_SARSS1 - Date of the SARSS1.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_sarss2b 
IS 'D_SARSS2B - Date of the SARSS2B.'; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.age_doc_s1 
IS 'AGE_DOC_S1 - Age of S1 in '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.age_s1_s2b 
IS 'AGE_S1_S2B - Age of S2B in '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.fund 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.d_iss_month 
IS 'D_ISS_MONTH - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.iss_mon 
IS 'ISS_MON - '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.dodaac 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.age_s1_iss 
IS 'AGE_S1_ISS - Age of S1_ISS in '; 

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.sfx 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.status 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.grab_stamp 
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.proc_stamp 
IS 'PROC_STAMP - The date timestamp (sysdate) of the promotion action.  ie: "BLD to POTENITAL" or "BLD to production"';       

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.active_date 
IS 'ACTIVE_DATE - Additional control for active_Fl indicating when the record became active.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.source_rec_id
IS 'SOURCE_REC_ID - ';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.inactive_date 
IS 'INACTIVE_DATE - Additional control for active_Fl indicating when the record went inactive.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.lst_update_rec_id
IS 'LST_UPDATE_REC_ID - ';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.delete_date 
IS 'DELETE_DATE - Additional control for DELETE_FLAG indicating when the record was marked for deletion.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.hidden_date 
IS 'HIDDEN_DATE - Addition control for HIDDEN_FLAG indicating when the record was hidden.';

COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.docno_uic
...
COMMENT ON COLUMN frz_pfsa_supply_ilap_tmp.docno_force_unit_id
...
WHERE  table_name = UPPER('frz_pfsa_supply_ilap_tmp'); 
*/
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('frz_pfsa_supply_ilap_tmp') 
    AND  a.column_name = b.column_name
WHERE    a.table_name = UPPER('frz_pfsa_supply_ilap_tmp') 
