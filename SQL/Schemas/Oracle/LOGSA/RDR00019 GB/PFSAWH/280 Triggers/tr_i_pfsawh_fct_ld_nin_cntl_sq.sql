...
--
--
--        NAME:    tr_i_pfsawh_fct_ld_nin_cntl_sq.sql
-- 
...
CREATE OR REPLACE TRIGGER tr_i_pfsawh_fct_ld_nin_cntl_sq

BEFORE UPDATE OR INSERT
ON pfsawh_fact_ld_niin_cntrl
...
BEGIN 
    ...
    IF inserting THEN
        ...
        SELECT pfsawh_fact_ld_niin_cntrl_seq.nextval 
        INTO   v_rec_id 
        FROM   dual;
