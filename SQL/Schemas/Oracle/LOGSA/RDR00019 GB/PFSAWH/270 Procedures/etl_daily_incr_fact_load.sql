/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: etl_daily_incr_fact_load 
--            SP Desc: 
--
--      SP Created By: Gene Belford
--    SP Created Date: 5 Novemner 2008 
--
--          SP Source: etl_daily_incr_fact_load.sql 
-- 
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
BEGIN 
    ...
    etl_daily_incr_fact_load ('GBelford'); 
...
CREATE OR REPLACE PROCEDURE etl_daily_incr_fact_load    
    (
...
-- update the pfsa_process table to indicate SUB process has started 
    ...
    IF run_today('daily_incr_item_sn_p_ft_load') THEN 
        daily_incr_item_sn_p_ft_load(ps_this_process.who_ran); 
    ELSE 
...
-- update the pfsa_process table to indicate SUB process has started 
    ...
    IF run_today('daily_incr_item_mnt_wrk_ft_ld') THEN 
        daily_incr_item_mnt_wrk_ft_ld(ps_this_process.who_ran); 
    ELSE 
        l_call_error := 'SKIPPED'; 
    END IF; 
...
END; -- end of ETL_DAILY_INCR_FACT_LOAD procedure 
/
