...
This procedure updates a record in the cbmwh_PROCESSES table
...
v_dir  varchar2(30) := '/home/opuamac/cbmwhwh/logs';
v_file varchar2(50) := 'cbmwhwh_production.log';

BEGIN

    UPDATE cbmwh_processes 
    ...
    WHERE cbmwh_process = i_cbmwh_process;
...
--    utl_file.put_line(file_hand, i_cbmwh_process||'...'||i_last_run_status);
--    utl_file.fclose(file_hand);

EXCEPTION 
    WHEN OTHERS THEN
        ps_oerr   := sqlcode;
        ps_id_key := i_cbmwh_process;
