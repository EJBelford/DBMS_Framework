...
CREATE OR REPLACE PROCEDURE etl_pfsa_usage_event    
    (
...
--    ps_location := 'PFSA 10';            -- For std_cbmwh_debug_tbl logging.
...
--    ps_location := 'PFSA 20';            -- For std_cbmwh_debug_tbl logging.
...
--    ps_location := 'PFSA 30';            -- For std_cbmwh_debug_tbl logging.
...
--    ps_location := 'PFSA 40';            -- For std_cbmwh_debug_tbl logging.
...
--    COMMIT; 
--    
--    ps_location := 'PFSA 44';            -- For std_cbmwh_debug_tbl logging.
...
----    
----    UPDATE pfsa_sn_ei_tmp sn 
----    SET    physical_item_sn_id = fn_cbmwh_get_item_sn_dim_id(sn.sys_ei_niin, sn.sys_ei_sn); 
----    
----    proc0.rec_updated_int := NVL(proc0.rec_updated_int, 0) + SQL%ROWCOUNT;
----    proc1.rec_updated_int := NVL(proc1.rec_updated_int, 0) + SQL%ROWCOUNT;
...
----    
----    UPDATE pfsa_sn_ei_tmp sn 
----    SET    mimosa_item_sn_id   = LPAD(LTRIM(TO_CHAR(fn_cbmwh_get_item_sn_dim_id(sn.sys_ei_niin, sn.sys_ei_sn) , 'XXXXXXX')), 8, '0');
----    
----    proc0.rec_updated_int := NVL(proc0.rec_updated_int, 0) + SQL%ROWCOUNT;
----    proc1.rec_updated_int := NVL(proc1.rec_updated_int, 0) + SQL%ROWCOUNT;
...
----    COMMIT; 
--    
--    ps_location := 'PFSA 46';            -- For std_cbmwh_debug_tbl logging.
...
--    ps_location := 'PFSA 48';            -- For std_cbmwh_debug_tbl logging.
--    
---- Set warehouse ids    
...
--/*----------------------------------------------------------------------------*/ 
--  
--    ps_location := 'PFSA 49';            -- For std_cbmwh_debug_tbl logging.
...
--    END IF;
--  
--    ps_location := 'PFSA 50';            -- For std_cbmwh_debug_tbl logging.
...
--    
--    ps_location := 'PFSA 60';            -- For std_cbmwh_debug_tbl logging.
...
--        );
--        
--    ps_location := 'PFSA 70';            -- For std_cbmwh_debug_tbl logging. 
--    
...
--    ps_location := 'PFSA 73';            -- For std_cbmwh_debug_tbl logging.
...
--        FROM   cbmwh_force_unit_dim pfui
...
--        );
--        
--    ps_location := 'PFSA 75';            -- For std_cbmwh_debug_tbl logging. 
--    
--    DELETE cbmwh_supply_ilap_p_fact
...
--    COMMIT;     
--        
----    SELECT niin, fn_cbmwh_get_item_dim_id(niin) 
----    FROM   cbmwh_supply_ilap_p_fact; 

--    UPDATE cbmwh_supply_ilap_p_fact 
--    SET    pniin_item_id = fn_cbmwh_get_item_dim_id(niin) 
...
/*----------------------------------------------------------------------------*/  
    ...
    ps_location := 'PFSA 90';            -- For std_cbmwh_debug_tbl logging. 
...
/*----------------------------------------------------------------------------*/ 
    ...
    ps_location := 'PFSA 92';            -- For std_cbmwh_debug_tbl logging. 
    ...
    ps_location := 'PFSA 94';            -- For std_cbmwh_debug_tbl logging. 
    ...
    ps_location := 'PFSA 96';            -- For std_cbmwh_debug_tbl logging. 
...
-- Set warehouse ids    
    ...
    ps_location := 'PFSA 97';            -- For std_cbmwh_debug_tbl logging. 
...
-- MIMOSA      
    ...
    ps_location := 'PFSA 98';            -- For std_cbmwh_debug_tbl logging. 
...
/*----------------------------------------------------------------------------*/  
    ...
    ps_location := 'PFSA 100';            -- For std_cbmwh_debug_tbl logging. 
...
/*----------------------------------------------------------------------------*/ 
    ...
    ps_location := 'PFSA 104';            -- For std_cbmwh_debug_tbl logging. 
...
--            psi.maint_ev_id              = tmp.maint_ev_id,            
    ...
    ps_location := 'PFSA 105';            -- For std_cbmwh_debug_tbl logging.
...
/*----------------------------------------------------------------------------*/  
    ...
    ps_location := 'PFSA 110';            -- For std_cbmwh_debug_tbl logging. 
...
--            psi.maint_item_id = tmp.maint_item_id,
    ...
    ps_location := 'PFSA 115';            -- For std_cbmwh_debug_tbl logging.
...
/*----------------------------------------------------------------------------*/  
    ...
    ps_location := 'PFSA 120';            -- For std_cbmwh_debug_tbl logging. 
...
--            psi.maint_task_id              = tmp.maint_task_id,            
    ...
    ps_location := 'PFSA 125';            -- For std_cbmwh_debug_tbl logging.
...
/*----------------------------------------------------------------------------*/  
    ...
    ps_location := 'PFSA 130';            -- For std_cbmwh_debug_tbl logging. 
...
--            psi.maint_work_id              = tmp.maint_work_id,            
    ...
    ps_location := 'PFSA 133';            -- For std_cbmwh_debug_tbl logging.
...
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
/*                                                                            */
/*                    Populate cbmwh_maint_itm_wrk_fact                      */
/*                                                                            */
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/ 
    ...
    ps_location := 'PFSA 135';            -- For std_cbmwh_debug_tbl logging. 
...
-- MIMOSA      
    ...
    UPDATE cbmwh_maint_itm_wrk_fact 
    SET    mimosa_item_sn_id = LPAD(LTRIM(TO_CHAR(physical_item_sn_id, 'XXXXXXX')), 8, '0') 
    WHERE  physical_item_sn_id >= 0 
        AND (mimosa_item_sn_id IS NULL OR mimosa_item_sn_id = '00000000')
        AND etl_processed_by = ps_procedure_name; 
...
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
/*                                                                            */
/*                    Populate cbmwh_maint_itm_prt_fact                      */
/*                                                                            */
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/ 
/*
    INSERT 
    INTO   cbmwh_maint_itm_prt_fact 
        (
        tsk_end_date_id, 
        tsk_end_time_id, 
        physical_item__id, 
    ...
    SELECT CASE 
               WHEN tk.tsk_end <> NULL THEN fn_cbmwh_get_date_dim_id(tk.tsk_end)   
               WHEN ev.dt_maint_ev_cmpl <> NULL THEN fn_cbmwh_get_date_dim_id(ev.dt_maint_ev_cmpl) 
               ELSE 10000 
           END CASE, 
           NVL(tk.tsk_end, NVL(ev.dt_maint_ev_cmpl, '01-JAN-1950')) AS tsk_end_time_id, 
           fn_cbmwh_get_item_dim_id(NVL(ev.sys_ei_niin, '000000000')) AS physical_item_id,  
           NVL(ev.sys_ei_sn, 'UNKNOWN') AS physical_item_sn_id, 
           fn_cbmwh_get_item_dim_id(NVL(ev.maint_item_niin, '000000000')) AS item_comp_id,  
           fn_cbmwh_get_item_dim_id(NVL(it.niin, '000000000')) AS item_part_id, 
...
--           ev.* 
    FROM   pfsa_maint_event@cbmwh.lidbdev ev, 
           ...
           pfsa_maint_items@cbmwh.lidbdev it 
