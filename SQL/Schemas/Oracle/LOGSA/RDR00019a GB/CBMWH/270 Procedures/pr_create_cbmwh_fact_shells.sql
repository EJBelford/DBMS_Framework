/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: pr_create_cbmwh_fact_shells 
--            SP Desc: 
--
--      SP Created By: Gene Belford 
--    SP Created Date: 24 September 2008 
--
--          SP Source: pr_create_cbmwh_fact_shells.sql 
--
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
BEGIN 
    ...
    pr_create_cbmwh_fact_shells ('GBelford'); 
...
CREATE OR REPLACE PROCEDURE pr_create_cbmwh_fact_shells    
    (
...
-- Call the xxxxx routine.  
    ...
    ls_current_process.cbmwh_process := 'FACT-Annual, Period'; 
...
--            NVL((SELECT physical_item_id 
--            FROM   cbmwh_item_dim 
--            WHERE  niin = cisd.item_niin
--            ), -1)
--    WHERE  cisd.physical_item_id IS NULL 
--        OR cisd.physical_item_id < 1; 
...
-- Call the xxxxx routine.  
    ...
    ps_location := 'cbmwh 90';            -- For std_cbmwh_debug_tbl logging.

    proc1.rec_inserted_int := NULL;

    ls_current_process.cbmwh_process := 'FACT-Life'; 
...
/*----------------------------------------------------------------------------*/ 
    ...
    ps_location := 'cbmwh 97';            -- For std_cbmwh_debug_tbl logging.
    ...
    ps_location := 'cbmwh 98';            -- For std_cbmwh_debug_tbl logging.
