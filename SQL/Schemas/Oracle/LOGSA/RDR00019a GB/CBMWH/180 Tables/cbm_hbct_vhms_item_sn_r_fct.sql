/*--*----|----*----|----*----|---- TEAM ITSS ----|----*----|----*----|----*---*/
-- 
--         NAME: ccbm_hbct_vhms_item_sn_r_fct 
--      PURPOSE: n/a. 
--
-- TABLE SOURCE: cbm_hbct_vhms_item_sn_r_fct.sql 
--
--   CREATED BY: Gene Belford 
-- CREATED DATE: 13 January 2009  
--
--  ASSUMPTIONS:
--
--  LIMITATIONS:
...
-- DROP SEQUENCE cbm_hbct_vhms_item_sn_r_fct_seq;
...
DROP TABLE cbm_hbct_vhms_item_sn_r_fct;
	
CREATE TABLE cbm_hbct_vhms_item_sn_r_fct
    (
...
COMMENT ON TABLE cbm_hbct_vhms_item_sn_r_fct 
IS 'CBM_HBCT_VHMS_ITEM_SN_R_FCT - This table serves as the period fact for a particular item/serial number combination.'; 


COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.rec_id 
IS 'REC_ID - Primary, blind key of the cbm_hbct_vhms_item_sn_r_fct table.'; 

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.date_id 
IS 'DATE_ID - Foreign key of the PFSAWH_DATE_DIM table.'; 

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_date_from_id 
IS 'ITEM_DATE_FROM_ID - Start date of the availability report period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_time_from_id 
IS 'ITEM_TIME_FROM_ID - Start time of the availability report period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_date_to_id 
IS 'ITEM_DATE_TO_ID - End date of the availability report period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_time_to_id 
IS 'ITEM_TIME_TO_ID - End time of the availability report period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.physical_item_id 
IS 'PHYSICAL_ITEM_ID - Foreign key of the cbmwh_item_DIM table.';
   
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.physical_item_sn_id 
IS 'PHYSICAL_ITEM_SN_ID - Foreign key of the cbmwh_item_SN_DIM table.';
    
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.mimosa_item_sn_id 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.pba_id 
IS 'PBA_ID - '; 
    
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_location_id 
IS 'ITEM_LOCATION_ID - Foreign key of the PFSAWH_LOCATION_DIM table.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_force_id 
IS 'ITEM_FORCE_ID - Foreign key of the PFSAWH_FORCE_DIM table.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_usage 
IS 'ITEM_USAGE - The actual usage of the system/end item accumulated during the period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_usage_type 
IS 'ITEM_USAGE_TYPE - An indicator of the type of usage captured.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.item_days 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.nmcm_int_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.nmcm_dep_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.nmcs_int_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.nmcs_dep_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.pmcm_hrs 
IS 'PMCM_HRS - The total number of hours in a partial mission capable maintenance status during the indicated period.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.pmcm_user_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.pmcm_int_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.pmcs_int_hrs 
...
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.maint_action_cnt 
IS 'MAINT_ACTION_CNT - The number of maintenance actions that have been identified during the period';
 
COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.meantime_btwn_maint_act 
IS 'MEANTIME_BTWN_MAINT_ACT - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.meandown_item 
IS 'MEANDOWN_ITEM - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.customer_wait_time 
IS 'CUSTOMER_WAIT_TIME - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.operational_readiness_rate 
IS 'OPERATIONAL_READINESS_RATE - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.operating_cost_per_hour 
IS 'OPERATING_COST_PER_HOUR - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.cost_parts 
IS 'COST_PARTS - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.cost_manpower 
IS 'COST_MANPOWER - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.deferred_maint_items 
IS 'DEFERRED_MAINT_ITEMS - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.operat_hrs_since_last_overhaul 
IS 'OPERAT_HRS_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.maint_hrs_since_last_overhaul 
IS 'MAINT_HRS_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.time_since_last_overhaul 
IS 'TIME_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.notes 
IS 'NOTES - Processing notes from the ETL process.'; 

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.status 
IS 'STATUS - The status of the record in question.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.active_date 
IS 'ACTIVE_DATE - Addition control for active_Fl indicating when the record became active.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.inactive_date 
IS 'INACTIVE_DATE - Addition control for active_Fl indicating when the record went inactive.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.delete_date 
IS 'DELETE_DATE - Addition control for DELETE_FLAG indicating when the record was marked for deletion.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';

COMMENT ON COLUMN cbm_hbct_vhms_item_sn_r_fct.hidden_date 
...
WHERE  table_name = UPPER('cbm_hbct_vhms_item_sn_r_fct'); 
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('cbm_hbct_vhms_item_sn_r_fct') 
    AND a.column_name = b.column_name
WHERE    a.table_name = UPPER('cbm_hbct_vhms_item_sn_r_fct') 
...
ALTER TABLE cbm_hbct_vhms_item_sn_r_fct  
    DROP CONSTRAINT pk_cbm_hbct_vhms_item_sn_r_fct; 
    
ALTER TABLE cbm_hbct_vhms_item_sn_r_fct  
    ADD CONSTRAINT  pk_cbm_hbct_vhms_item_sn_r_fct 
    PRIMARY KEY 
        (
        rec_id
        );    
...
CREATE INDEX idx_cbm_hbct_vhms_itm_sn_r_fct 
    ON cbm_hbct_vhms_item_sn_r_fct
        (
        date_id, 
        item_date_from_id,
        item_date_to_id,
...
SELECT * 
FROM   cbm_hbct_vhms_item_sn_r_fct; 
