/*--*----|----*----|----*----|---- TEAM ITSS ----|----*----|----*----|----*---*/
-- 
--         NAME: cbmwh_item_sn_p_fact
--      PURPOSE: n/a. 
--
-- TABLE SOURCE: cbmwh_item_sn_p_fact.sql
--
...
DROP SEQUENCE cbmwh_item_sn_p_fact_seq;

CREATE SEQUENCE cbmwh_item_sn_p_fact_seq
    START WITH 1
--    MAXVALUE 999999999 
    MINVALUE 1
    NOCYCLE
...
DROP TABLE cbmwh_item_sn_p_fact;
	
CREATE TABLE cbmwh_item_sn_p_fact
    (
...
-- 
    ...
    item_usag_pri_wepn_rnd_fire      NUMBER,
    item_usag_secn_wepn_rnd_fire     NUMBER,
--
    item_days                        NUMBER , 
    period_hrs                       NUMBER , 
    mc_hrs                           NUMBER , 
...
COMMENT ON TABLE cbmwh_item_sn_p_fact 
IS 'CBMWH_ITEM_SN_P_FACT - This table serves as the period fact for a particular item/serial number combination.'; 


COMMENT ON COLUMN cbmwh_item_sn_p_fact.rec_id 
IS 'REC_ID - Primary, blind key of the cbmwh_item_sn_p_fact table.'; 

COMMENT ON COLUMN cbmwh_item_sn_p_fact.period_type  
IS 'PERIOD_TYPE - '; 

COMMENT ON COLUMN cbmwh_item_sn_p_fact.date_id 
IS 'DATE_ID - Foreign key of the PFSAWH_DATE_DIM table.'; 

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_date_from_id 
IS 'ITEM_DATE_FROM_ID - Start date of the availability report period.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_time_from_id 
IS 'ITEM_TIME_FROM_ID - Start time of the availability report period.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_date_to_id 
IS 'ITEM_DATE_TO_ID - End date of the availability report period.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_time_to_id 
IS 'ITEM_TIME_TO_ID - End time of the availability report period.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.physical_item_id 
IS 'PHYSICAL_ITEM_ID - Foreign key of the cbmwh_item_DIM table.';
   
COMMENT ON COLUMN cbmwh_item_sn_p_fact.physical_item_sn_id 
IS 'PHYSICAL_ITEM_SN_ID - Foreign key of the cbmwh_item_SN_DIM table.';
    
COMMENT ON COLUMN cbmwh_item_sn_p_fact.mimosa_item_sn_id 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.pba_id 
IS 'PBA_ID - '; 
    
COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_location_id 
IS 'ITEM_LOCATION_ID - Foreign key of the PFSAWH_LOCATION_DIM table.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_force_id 
IS 'ITEM_FORCE_ID - Foreign key of the PFSAWH_FORCE_DIM table.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_usage 
IS 'ITEM_USAGE - The actual usage of the system/end item accumulated during the period.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_usage_type 
IS 'ITEM_USAGE_TYPE - An indicator of the type of usage captured.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.item_days 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.nmcm_int_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.nmcm_dep_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.nmcs_int_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.nmcs_dep_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.pmcm_int_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.pmcs_int_hrs 
...
COMMENT ON COLUMN cbmwh_item_sn_p_fact.maint_action_cnt 
IS 'MAINT_ACTION_CNT - The number of maintenance actions that have been identified during the period';
 
COMMENT ON COLUMN cbmwh_item_sn_p_fact.meantime_btwn_maint_act 
IS 'MEANTIME_BTWN_MAINT_ACT - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.meandown_item 
IS 'MEANDOWN_ITEM - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.customer_wait_time 
IS 'CUSTOMER_WAIT_TIME - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.operational_readiness_rate 
IS 'OPERATIONAL_READINESS_RATE - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.operating_cost_per_hour 
IS 'OPERATING_COST_PER_HOUR - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.cost_parts 
IS 'COST_PARTS - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.cost_manpower 
IS 'COST_MANPOWER - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.deferred_maint_items 
IS 'DEFERRED_MAINT_ITEMS - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.operat_hrs_since_last_overhaul 
IS 'OPERAT_HRS_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.maint_hrs_since_last_overhaul 
IS 'MAINT_HRS_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.time_since_last_overhaul 
IS 'TIME_SINCE_LAST_OVERHAUL - ';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.notes 
IS 'NOTES - Processing notes from the ETL process.'; 

COMMENT ON COLUMN cbmwh_item_sn_p_fact.status 
IS 'STATUS - The status of the record in question.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.updt_by 
IS 'UPDT_BY - The date/timestamp of when the record was created/updated.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.lst_updt 
IS 'LST_UPDT - Indicates either the program name or user ID of the person who updated the record.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.active_flag 
IS 'ACTIVE_FLAG - Flag indicating if the record is active or not.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.active_date 
IS 'ACTIVE_DATE - Addition control for active_Fl indicating when the record became active.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.inactive_date 
IS 'INACTIVE_DATE - Addition control for active_Fl indicating when the record went inactive.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.insert_by 
IS 'INSERT_BY - Reports who initially created the record.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.insert_date 
IS 'INSERT_DATE - Reports when the record was initially created.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.update_by 
IS 'UPDATE_BY - Reports who last updated the record.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.update_date 
IS 'UPDATE_DATE - Reports when the record was last updated.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.delete_flag 
IS 'DELETE_FLAG - Flag indicating if the record can be deleted.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.delete_date 
IS 'DELETE_DATE - Addition control for DELETE_FLAG indicating when the record was marked for deletion.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.hidden_flag 
IS 'HIDDEN_FLAG - Flag indicating if the record should be hidden from the general user in things like drop-down lists.';

COMMENT ON COLUMN cbmwh_item_sn_p_fact.hidden_date 
...
WHERE  table_name = UPPER('cbmwh_item_sn_p_fact'); 
...
LEFT OUTER JOIN user_tab_columns b ON b.table_name = UPPER('cbmwh_item_sn_p_fact') 
    AND a.column_name = b.column_name
WHERE    a.table_name = UPPER('cbmwh_item_sn_p_fact') 
...
ALTER TABLE cbmwh_item_sn_p_fact  
    DROP CONSTRAINT pk_cbmwh_item_sn_p_fact; 
    
ALTER TABLE cbmwh_item_sn_p_fact  
    ADD CONSTRAINT  pk_cbmwh_item_sn_p_fact 
    PRIMARY KEY 
        (
        rec_id
        );    
...
DROP INDEX idx_cbmwh_item_sn_p_fact;

CREATE INDEX idx_cbmwh_item_sn_p_fact 
...
DROP INDEX idx_cbmwh_item_sn_p_fact_sys;

CREATE INDEX idx_cbmwh_item_sn_p_fact_sys 
    ON cbmwh_item_sn_p_fact
        (
        physical_item_id
        );

DROP INDEX idx_cbmwh_item_sn_p_fact_sn;

CREATE INDEX idx_cbmwh_item_sn_p_fact_sn 
    ON cbmwh_item_sn_p_fact
        (
        physical_item_sn_id
        );
...
ALTER TABLE cbmwh_item_sn_p_fact  
    DROP CONSTRAINT fk_cbmwh_item_sn_p_fact_itm;        

ALTER TABLE cbmwh_item_sn_p_fact  
    ADD CONSTRAINT fk_cbmwh_item_sn_p_fact_itm
    FOREIGN KEY 
        (
        physical_item_id
        ) 
...
ALTER TABLE cbmwh_item_sn_p_fact  
    DROP CONSTRAINT fk_cbmwh_item_sn_p_fact_itmsn;        

ALTER TABLE cbmwh_item_sn_p_fact  
    ADD CONSTRAINT fk_cbmwh_item_sn_p_fact_itmsn
    FOREIGN KEY 
        (
--        physical_item_id, 
        physical_item_sn_id
...
ALTER TABLE cbmwh_item_sn_p_fact  
    DROP CONSTRAINT fk_cbmwh_item_sn_p_fact_pbaid;        

ALTER TABLE PFSAWH.cbmwh_item_sn_p_fact 
    ADD CONSTRAINT fk_cbmwh_item_sn_p_fact_pbaid 
    FOREIGN KEY 
        (
        pba_id
        ) 
