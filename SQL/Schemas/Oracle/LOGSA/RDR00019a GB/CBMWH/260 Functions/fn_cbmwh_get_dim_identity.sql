...
CREATE OR REPLACE FUNCTION fn_cbmwh_get_dim_identity 
    (
    in_dimension_tablename   
        cbmwh_identities.dimension_tablename%TYPE
    )
    RETURN cbmwh_identities.last_dimension_identity%TYPE 
...
/********************************* TEAM ITSS ***********************************
   ...
   LOCATION: cbmwh@liwwhdev.logsa.army.mil
...
in_dimension_tablename   
    gb_cbmwh_identities.dimension_tablename%TYPE  := 'cbmwh_ITEM_DIM';
*/
-- Exception handling variables (ps_)

ps_procedure_name        VARCHAR2(30)  := 'fn_cbmwh_get_dim_identity';
...
DECLARE
    ...
    identity cbmwh_identities.last_dimension_identity%TYPE; 

BEGIN 
 
    identity := fn_cbmwh_get_dim_identity('cbmwh_ITEM_DIMx'); 
     
    identity := fn_cbmwh_get_dim_identity('cbmwh_ITEM_DIM'); 
