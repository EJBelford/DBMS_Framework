...
CREATE OR REPLACE FUNCTION fn_cbmwh_get_item_sn_dim_id
    (
    v_item       VARCHAR2,   
    v_item_sn    VARCHAR2  
    ) 
...
ps_exception                     std_cbmwh_debug_tbl%ROWTYPE; 
...
BEGIN 
    ...
    ps_exception.ps_procedure := 'fn_cbmwh_get_item_sn_dim_id'; 
...
END fn_cbmwh_get_item_sn_dim_id; 
