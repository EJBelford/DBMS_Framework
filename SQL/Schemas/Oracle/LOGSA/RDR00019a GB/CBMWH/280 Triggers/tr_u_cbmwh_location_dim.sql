/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--        NAME:    tr_u_cbmwh_location_dim
--
--     PURPOSE:    To perform work as each row is updated. 
-- 
--      SOURCE:    tr_u_cbmwh_location_dim.sql
--   
-- ASSUMPTIONS:
--
-- LIMITATIONS:
...
CREATE OR REPLACE TRIGGER tr_u_cbmwh_location_dim 
BEFORE UPDATE
...
v_update_date cbmwh_location_dim.update_date%TYPE  := sysdate;
v_update_by   cbmwh_location_dim.update_by%TYPE    := user;
