...
CREATE OR REPLACE TRIGGER tr_u_cbmwh_item_dim
BEFORE UPDATE
ON     cbmwh_item_dim 
FOR EACH ROW
DECLARE
...
v_update_date cbmwh_item_dim.update_date%TYPE  := sysdate;
v_update_by   cbmwh_item_dim.update_by%TYPE    := user;
