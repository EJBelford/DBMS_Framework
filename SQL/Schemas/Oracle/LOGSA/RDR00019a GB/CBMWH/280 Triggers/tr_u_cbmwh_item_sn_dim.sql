/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--        NAME:    tr_u_cbmwh_item_sn_dim
--
--     PURPOSE:    To perform work as each row is updated. 
-- 
--      SOURCE:    tr_u_cbmwh_item_sn_dim.sql 
--   
-- ASSUMPTIONS:
--
-- LIMITATIONS:
...
CREATE OR REPLACE TRIGGER tr_u_cbmwh_item_sn_dim
BEFORE UPDATE
...
v_update_date cbmwh_item_sn_dim.update_date%TYPE  := sysdate;
v_update_by   cbmwh_item_sn_dim.update_by%TYPE    := user;
