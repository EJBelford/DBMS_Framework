/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--        NAME:    tr_u_cbmwh_processes
--
--     PURPOSE:    To perform work as each row is updated. 
-- 
--      SOURCE:    tr_u_cbmwh_processes.sql
--   
-- ASSUMPTIONS:
--
-- LIMITATIONS:
...
CREATE OR REPLACE TRIGGER tr_u_cbmwh_processes
BEFORE UPDATE
ON     cbmwh_processes
FOR EACH ROW
DECLARE
...
v_update_date cbmwh_processes.update_date%TYPE  := sysdate;
v_update_by   cbmwh_processes.update_by%TYPE    := user;
