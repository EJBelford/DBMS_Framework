...
spool index.log
  ...
  ALTER TABLE sg_prop_ev_log_conn ADD CONSTRAINT FK1324 FOREIGN KEY(sg_prop_amb_set_db_site,sg_prop_amb_set_db_id,sg_prop_amb_set_id,par_log_conn_id) REFERENCES sg_prop_ev_log_conn(sg_prop_amb_set_db_site,sg_prop_amb_set_db_id,sg_prop_amb_set_id,log_conn_id);
