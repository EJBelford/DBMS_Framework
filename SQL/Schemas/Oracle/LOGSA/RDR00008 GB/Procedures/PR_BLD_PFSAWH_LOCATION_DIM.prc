/*<TOAD_FILE_CHUNK>*/
CREATE OR REPLACE PROCEDURE pr_bld_pfsawh_location_dim 
    (
    in_rec_Id                IN      NUMBER  
    )
...
/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: pr_bld_pfsawh_location_dim
--            SP Desc: 
--
--      SP Created By: Gene Belford
--    SP Created Date: dd mmm yyyy 
--
--          SP Source: pr_bld_pfsawh_location_dim.sql
--
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
END pr_bld_pfsawh_location_dim;
