/*<TOAD_FILE_CHUNK>*/
CREATE OR REPLACE PROCEDURE pr_pfsawh_upd_item_dim 
    (
    in_rec_id                IN      NUMBER  
    )
...
/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: pr_pfsawh_upd_item_dim
--            SP Desc: 
--
--      SP Created By: Gene Belford
--    SP Created Date: 31 Jan 2008 
--
--          SP Source: pr_pfsawh_upd_item_dim.sql
--
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
CURSOR lin_cur IS
    SELECT	
        ...
        item.item_id, 
        item.nsn, 
        item.lin AS item_lin, 
        lin.lin AS lin_lin, 
        lin.chap, 
        lin.dt_assigned, 
        lin.dt_inact,  
        NVL(lin.gen_nomen, 'unk'),  
        LTRIM(lin.inactive_statement) AS inactive_statement, 
        lin.lin_ricc, 
        lin.mat_cat_cd_1, 
