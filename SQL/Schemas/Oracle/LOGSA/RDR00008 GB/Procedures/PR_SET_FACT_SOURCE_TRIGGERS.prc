/*<TOAD_FILE_CHUNK>*/
CREATE OR REPLACE PROCEDURE pr_set_fact_source_triggers 
    (
    in_rec_Id                IN      NUMBER  
    )
...
/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: pr_set_fact_source_triggers
--            SP Desc: 
--
--      SP Created By: Gene Belford
--    SP Created Date: dd mmm yyyy 
--
--          SP Source: pr_set_fact_source_triggers.sql
--
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
END pr_set_fact_source_triggers;
