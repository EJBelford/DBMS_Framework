/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--        NAME:    tr_u_pfsawh_xx_updt
--
--     PURPOSE:    To perform work as each row is updated. 
-- 
--      SOURCE:    tr_u_pfsawh_xx_updt.trg
--   
-- ASSUMPTIONS:
--
-- LIMITATIONS:
...
CREATE OR REPLACE TRIGGER tr_u_pfsawh_xx_updt
BEFORE UPDATE
ON     gb_pfsawh_xx_dim
FOR EACH ROW
DECLARE
...
v_update_date gb_pfsawh_xx_dim.update_date%TYPE  := sysdate;
v_update_by   gb_pfsawh_xx_dim.update_by%TYPE    := user;
