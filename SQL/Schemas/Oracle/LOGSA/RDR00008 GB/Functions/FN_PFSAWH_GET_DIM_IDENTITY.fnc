...
CREATE OR REPLACE FUNCTION fn_pfsawh_get_dim_identity 
    ...
    in_dimension_tablename   
        pfsawh_identities.dimension_tablename%TYPE
    )
    RETURN pfsawh_identities.last_dimension_identity%TYPE 
...
DECLARE
    ...
    identity pfsawh_identities.last_dimension_identity%TYPE; 
