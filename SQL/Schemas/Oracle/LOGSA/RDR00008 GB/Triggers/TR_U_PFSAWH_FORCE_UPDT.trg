...
CREATE OR REPLACE TRIGGER tr_u_pfsawh_force_updt
BEFORE UPDATE
ON     pfsawh_force_dim
FOR EACH ROW
DECLARE
...
v_update_date pfsawh_force_dim.update_date%TYPE  := sysdate;
v_update_by   pfsawh_force_dim.update_by%TYPE    := user;
