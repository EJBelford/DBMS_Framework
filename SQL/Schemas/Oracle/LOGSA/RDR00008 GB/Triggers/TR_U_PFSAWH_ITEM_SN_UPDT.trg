/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--        NAME:    tr_u_pfsawh_item_sn_updt
--
--     PURPOSE:    To perform work as each row is updated. 
-- 
--      SOURCE:    tr_u_pfsawh_item_sn_updt.trg
--   
-- ASSUMPTIONS:
--
-- LIMITATIONS:
...
CREATE OR REPLACE TRIGGER tr_u_pfsawh_item_sn_updt
BEFORE UPDATE
...
v_update_date pfsawh_item_sn_dim.update_date%TYPE  := sysdate;
v_update_by   pfsawh_item_sn_dim.update_by%TYPE    := user;
