...
--
--
--        NAME:    tr_i_pfsawh_force_unit_seq.trg
-- 
...
CREATE OR REPLACE TRIGGER tr_i_pfsawh_force_unit_seq
BEFORE INSERT
...
BEGIN
    ...
    SELECT pfsawh_force_unit_dim_seq.nextval 
    INTO   v_rec_id 
    FROM   dual;
...
END tr_i_gb_pfsawh_force_unit_seq;
