...
DROP SEQUENCE gb_pfsawh_process_log_seq;

CREATE SEQUENCE gb_pfsawh_process_log_seq
    START WITH 1000000
    MAXVALUE 9999999
    MINVALUE 1
    NOCYCLE
...
----------  ---------------  ---------------  ---------------------------------
12/18/2007                   Gene Belford     Trigger Created
*/

CREATE OR REPLACE TRIGGER tr_i_gb_pfsawh_process_seq
    BEFORE INSERT
    ON gb_pfsawh_process_log
...
BEGIN
    ...
    SELECT gb_pfsawh_process_log_seq.NEXTVAL 
    INTO   v_process_key 
    FROM   dual;
...
END tr_i_gb_pfsawh_process_seq;
