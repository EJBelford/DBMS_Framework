CREATE OR REPLACE PROCEDURE pr_get_fact_source_statistics 
    (
    in_rec_Id                IN      NUMBER  
    )
...
/*--*----|----*----|----*----|---- Team ITSS ----|----*----|----*----|----*---*/
--
--            SP Name: pr_get_fact_source_statistics
--            SP Desc: 
--
--      SP Created By: Gene Belford
--    SP Created Date: dd mmm yyyy 
--
--          SP Source: pr_get_fact_source_statistics.sql
--
/*--*----|----*----|----*----|----*----|----*----|----*----|----*----|----*---*/
--      SP Parameters: 
--              Input: 
...
END pr_get_fact_source_statistics;
