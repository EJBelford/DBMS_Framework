/*<TOAD_FILE_CHUNK>*/
CREATE OR REPLACE PROCEDURE gb_load_pfsawh_avail_p_fact 
    (
    in_rec_Id                IN      NUMBER  
    )
...
--
    ...
    DELETE gb_pfsawh_availability_p_fact; 
    ...
    INSERT 
    INTO   gb_pfsawh_availability_p_fact
        (
--        rec_id ,
--    
        date_id , 
...
END GB_LOAD_PFSAWH_AVAIL_P_FACT;
