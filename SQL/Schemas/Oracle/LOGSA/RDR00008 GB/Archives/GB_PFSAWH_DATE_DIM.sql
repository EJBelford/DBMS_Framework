...
IS 'Identity for PFSA_DATE_DIM records.'; 
...
IS 'RESETWH DATE_DIM - Full day of week description, Monday, Tuesday, etc.';

COMMENT ON COLUMN gb_pfsawh_date_dim.day_num_in_month 
IS 'RESETWH DATE_DIM - Integer value between 1-31.';

COMMENT ON COLUMN gb_pfsawh_date_dim.day_num_overall 
IS 'RESETWH DATE_DIM - The number of days since 01-Jan-1950. ';

COMMENT ON COLUMN gb_pfsawh_date_dim.week_number_in_year 
IS 'RESETWH DATE_DIM - Integer value between 1-52 OR 53.  Calculation: DAY_NUM_OVERALL / 7 ';

COMMENT ON COLUMN gb_pfsawh_date_dim.week_number_overall 
IS 'RESETWH DATE_DIM - The number of weeks since 01-Jan-1950. ';

COMMENT ON COLUMN gb_pfsawh_date_dim.month_number_in_year 
IS 'RESETWH DATE_DIM - Calendar year. Integer value between 1-12.';

COMMENT ON COLUMN gb_pfsawh_date_dim.month_number_overall 
IS 'RESETWH DATE_DIM - The number of months since 01-Jan-1950';

COMMENT ON COLUMN gb_pfsawh_date_dim.calendar_quarter 
IS 'RESETWH DATE_DIM - Calendar year. Integer value between 1-4.';

COMMENT ON COLUMN gb_pfsawh_date_dim.fiscal_quarter 
IS 'RESETWH DATE_DIM - Fiscal year starting in October, 1st. Integer value between 1-4.';

COMMENT ON COLUMN gb_pfsawh_date_dim.holiday_flag 
IS 'RESETWH DATE_DIM - HOLIDAY OR NON-HOLIDAY';

COMMENT ON COLUMN gb_pfsawh_date_dim.weekday_flag 
IS 'RESETWH DATE_DIM - WEEKDAY OR WEEKEND DAY';

COMMENT ON COLUMN gb_pfsawh_date_dim.season 
IS 'RESETWH DATE_DIM - Do we need this? No, but we will keep it for now until reviewed with LIW. ';    

COMMENT ON COLUMN gb_pfsawh_date_dim.event 
IS 'RESETWH DATE_DIM - What do we define as an event?  yes, but we need to work out the definition.';

COMMENT ON COLUMN gb_pfsawh_date_dim.full_date_description 
IS 'Full date description.  "Sunday, January 01, 1950"';
   
COMMENT ON COLUMN gb_pfsawh_date_dim.oracle_date_from_time 
IS 'The minimum point in time considered to be part of the day date.  "DD-MMM-YYYY 00:00:00"'; 

COMMENT ON COLUMN gb_pfsawh_date_dim.oracle_date_to_time 
IS 'The maximum point in time considered to be part of the day date.  "DD-MMM-YYYY 23:59:59"';
...
IS 'The number number in the fiscal year since October.';

COMMENT ON COLUMN gb_pfsawh_date_dim.fiscal_year_month_yyyymm 
IS 'Aids in sorting by fiscal year and fiscal month.';

COMMENT ON COLUMN gb_pfsawh_date_dim.fiscal_year_quarter_yyyyqq 
IS 'Aids in sorting by fiscal year and fiscal quarter.';
...
IS 'Additional control for delete_Fl indicating when the record was marked for deletion.';
...
--
    ...
    VALUES    
        (
        v_loop_cnt + 10000, 
        TO_CHAR(TO_DATE('01-JAN-1950')+v_loop_cnt), 
