...
COMMENT ON COLUMN GB_PFSA_FLEET_DIM.FLEET_ID IS 'A major grouping End Items.';
...
COMMENT ON COLUMN GB_PFSA_FLEET_DIM.STATUS IS 'The date/timestamp of when the record was created/updated.';
