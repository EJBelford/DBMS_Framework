...
SELECT	rdd.date_id, rdd.oracle_date, rdd.DAY_OF_WEEK, rd.* 
FROM	resetwh.date_dim rdd 
LEFT OUTER JOIN pfsawh.pfsa_ready_dates_dim rd ON rdd.ORACLE_DATE = rd.ready_date
