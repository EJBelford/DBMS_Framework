...
COMMENT ON COLUMN gb_pfsawh_item_dim.physical_item_id 
...
COMMENT ON COLUMN gb_pfsawh_item_dim.item_nomen_short 
IS 'ITEM_NOMEN_SHORT - Description of the item.  On initial load it was taken from gcssa_lin.item_nomen.';

COMMENT ON COLUMN gb_pfsawh_item_dim.item_nomen_standard 
IS 'ITEM_NOMEN_STANDARD - Description of the item.  ';

COMMENT ON COLUMN gb_pfsawh_item_dim.item_nomen_long 
...
COMMENT ON COLUMN gb_pfsawh_item_dim.eic_model
...
COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_1_code 
IS 'MAT_CAT_CD_1 - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_1_desc 
IS 'MAT_CAT_CD_1_DESC - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_2_code 
IS 'MAT_CAT_CD_2 - ';
...
COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_3_code 
IS 'MAT_CAT_CD_3 - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_3_desc 
IS 'MAT_CAT_CD_3_DESC - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_4_code 
IS 'MAT_CAT_CD_4 - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_4_desc 
IS 'MAT_CAT_CD_4_DESC - ';

COMMENT ON COLUMN gb_pfsawh_item_dim.mat_cat_cd_4_5_code 
IS 'MAT_CAT_CD_4_5 - ';
...
COMMENT ON COLUMN gb_pfsawh_item_dim.cage_code 
...
COMMENT ON COLUMN gb_pfsawh_item_dim.subclass_of_supply_cd_desc 
