DROP TABLE gb_pfsawh_maint_task_dim;
	
/*--*----|----*----|----*----|---- TEAM ITSS ----*----|----|----*----|----*---*/
--
--         NAME: gb_pfsawh_maint_task_dim
--      PURPOSE: To calculate the desired information.
--
-- TABLE SOURCE: gb_pfsawh_maint_task_dim.sql
--
...
--
--
CREATE TABLE gb_pfsawh_maint_task_dim 
(
    rec_id                        NUMBER              NOT NULL ,
--
    maint_tsk_id                  NUMBER              DEFAULT    0 ,
...
CONSTRAINT pk_gb_pfsawh_maint_task_dim PRIMARY KEY 
    (
    rec_id
    )    
) 
...
CREATE UNIQUE INDEX ixu_pfsawh_maintenance_dim 
    ON gb_pfsawh_maint_task_dim(maint_tsk_id);

/*----- Foreign Key -----*/

ALTER TABLE gb_pfsawh_maint_task_dim  
...
ALTER TABLE gb_pfsawh_maint_task_dim  
    DROP CONSTRAINT ck_gb_pfsawh_maint_task_dim_status;        

ALTER TABLE gb_pfsawh_maint_task_dim  
    ADD CONSTRAINT ck_gb_pfsawh_maint_task_dim_status 
...
COMMENT ON TABLE gb_pfsawh_maint_task_dim 
IS ''; 


COMMENT ON COLUMN gb_pfsawh_maint_task_dim.rec_id 
IS ''; 

COMMENT ON COLUMN gb_pfsawh_maint_task_dim.STATUS 
...
WHERE  table_name = UPPER('gb_pfsawh_maint_task_dim') 
...
LEFT OUTER JOIN user_tab_columns b  
    ON  b.table_name  = UPPER('gb_pfsawh_maint_task_dim') 
    AND a.column_name = b.column_name
WHERE    a.table_name = UPPER('gb_pfsawh_maint_task_dim') 
...
DECLARE
    ...
    CURSOR code_cur IS
        ...
        FROM gb_pfsawh_maint_task_dim a
        ORDER BY a.catcode;
...
BEGIN 
    ...
    INSERT INTO gb_pfsawh_maint_task_dim (xx_id, xx_code, xx_description) 
...
SELECT * FROM gb_pfsawh_maint_task_dim; 
