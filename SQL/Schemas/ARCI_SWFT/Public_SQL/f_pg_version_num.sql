-- DROP FUNCTION IF EXISTS public.f_pg_version_num();

CREATE OR REPLACE FUNCTION public.f_pg_version_num() 
    RETURNS INT
...
SELECT public.f_pg_version_num();
...
COMMENT ON FUNCTION public.f_pg_version_num() 
...
ALTER FUNCTION public.f_pg_version_num() 
    OWNER TO postgres; 
