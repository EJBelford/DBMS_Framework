-- View: pcd_tracker.vw_pcd_funded_no_pcd

-- DROP VIEW pcd_tracker.vw_pcd_funded_no_pcd;

/*

SELECT *
FROM pcd_tracker.vw_pcd_funded_no_pcd;

*/

CREATE OR REPLACE VIEW pcd_tracker.vw_pcd_funded_no_pcd AS 
SELECT trk.rec_id,
...
WHERE trk.funded_flag = true AND pcd.pcd_id NOT LIKE '%ARCI%' 
