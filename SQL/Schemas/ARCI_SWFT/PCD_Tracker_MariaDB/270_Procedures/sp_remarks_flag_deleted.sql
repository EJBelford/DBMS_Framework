...
DROP PROCEDURE IF EXISTS pcd_tracker.sp_remarks_flag_deleted;

$$
CREATE PROCEDURE pcd_tracker.sp_remarks_flag_deleted(
    IN  p_rec_id        INT, 
...
/* Source File: sp_remarks_flag_deleted.sql                                   */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: sp_remarks_flag_deleted                                       */
/*      Author: Gene Belford                                                  */
...
CALL pcd_tracker.sp_remarks_flag_deleted(128, TRUE, @p_count);

CALL pcd_tracker.sp_remarks_flag_deleted(128, FALSE, @p_count);

-- Error tests below:

CALL pcd_tracker.sp_remarks_flag_deleted();

CALL pcd_tracker.sp_remarks_flag_deleted(-1, 'Bad value type', @p_count);
