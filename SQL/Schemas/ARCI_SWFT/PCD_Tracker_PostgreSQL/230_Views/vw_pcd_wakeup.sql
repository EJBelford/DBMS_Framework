/* Source File: vw_pcd_wakeup.sql                                             */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: vw_pcd_wakeup                                                 */
/*      Author: Gene Belford                                                  */
...
SELECT * FROM pcd_tracker.vw_pcd_wakeup;
...
-- DROP VIEW pcd_tracker.vw_pcd_wakeup;

CREATE OR REPLACE VIEW pcd_tracker.vw_pcd_wakeup 
...
ALTER TABLE pcd_tracker.vw_pcd_wakeup
    OWNER TO postgres;
