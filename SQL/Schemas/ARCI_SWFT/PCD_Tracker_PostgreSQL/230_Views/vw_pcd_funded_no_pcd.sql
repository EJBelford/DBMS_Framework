/* Source File: vw_pcd_funded_no_pcd.sql                                      */
/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: vw_pcd_funded_no_pcd                                          */
/*      Author: Gene Belford                                                  */
...
CREATE OR REPLACE VIEW pcd_tracker.vw_pcd_funded_no_pcd 
...
ALTER TABLE pcd_tracker.vw_pcd_funded_no_pcd
    OWNER TO postgres;
