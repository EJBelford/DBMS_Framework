/*--+----1----+----2----+----3----+----4----+----5----+----6----+----7----+---*/
/*                                                                            */
/* Module Name: <schema>.<tableName>_seq                                      */
/*      Author: <author>                                                      */
...
DROP SEQUENCE IF EXISTS <schema>.<tableName>_seq;

CREATE SEQUENCE <schema>.<tableName>_seq 
    INCREMENT   1
    MINVALUE    1
...
(
rec_id                INTEGER      NOT NULL DEFAULT nextval('<schema>.<tableName>_seq'::regclass),
--
...
--
man_sec_classification_tag      VARCHAR(254),
man_sec_classification_reason   VARCHAR(254),
man_sec_classified_by           VARCHAR(254),
man_sec_date_exempted_source    VARCHAR(254),
man_sec_d_6 VARCHAR(254),
man_sec_d_3 VARCHAR(254),
man_sec_d_4 VARCHAR(254),
man_sec_declass_manual_review   VARCHAR(254),
man_sec_d_1 VARCHAR(254),
man_sec_d_2 VARCHAR(254),
man_sec_d_0 VARCHAR(254),
man_sec_f_0 VARCHAR(254),
man_sec_f_1 VARCHAR(254),
man_sec_n_0 VARCHAR(254),
man_sec_o_0 VARCHAR(254),
man_sec_r_0 VARCHAR(254),
man_sec_s_1 VARCHAR(254),
man_sec_s_0 VARCHAR(254),
man_sec_t_0 VARCHAR(254), 
--
PRIMARY KEY (rec_id) 
)
WITH (
...
COMMENT ON TABLE <schema>.<tableName> 
IS '<tableName> - <description>';

COMMENT ON COLUMN <schema>.<tableName>.rec_id 
IS 'rec_id - The unquie durable single field key assigned to the record.';
COMMENT ON COLUMN <schema>.<tableName>.rec_uuid 
IS 'rec_uuid - Stores the Universally Unique IDentifier (UUID) as defined by RFC 4122, ISO/IEC 9834-8:2005.'; 
COMMENT ON COLUMN <schema>.<tableName>.<tableName>_nm 
IS '<fieldName> - ';
COMMENT ON COLUMN <schema>.<tableName>.<tableName>_desc 
IS '<fieldDesc> - ';

COMMENT ON COLUMN <schema>.<tableName>.status 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_c_2 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_c_1 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_7 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_6 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_3 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_4 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_5 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_1 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_2 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_d_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_f_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_f_1 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_n_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_o_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_r_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_s_1 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_s_0 
...
COMMENT ON COLUMN <schema>.<tableName>.mandatorymetadata_security_t_0 
...
-- ALTER TABLE <schema>.<tableName> DROP CONSTRAINT <tableName>_status; 
...
-- DROP TABLE IF EXISTS <schema>.<tableName>_audit;

CREATE TABLE <schema>.<tableName>_audit 
(
...
COMMENT ON TABLE <schema>.<tableName>_audit 
    IS '<tableName>_audit - Creates an audit table for <tableName> that tracks changes to the parent table as they are made.';


-- DROP FUNCTION IF EXISTS <schema>.f_<tableName>_audit;

CREATE OR REPLACE FUNCTION <schema>.f_<tableName>_audit() 
    RETURNS TRIGGER AS 
...
COMMENT ON FUNCTION <schema>.f_<tableName>_audit() 
    IS 'f_<tableName>_audit() - This function ';


ALTER FUNCTION <schema>.f_<tableName>_audit() 
    OWNER TO postgres; 
...
-- DROP TRIGGER IF EXISTS t_<tableName>_audit ON <schema>.<tableName>;

CREATE TRIGGER t_<tableName>_audit 
    AFTER INSERT OR UPDATE OR DELETE 
    ON <schema>.<tableName> 
    FOR EACH ROW 
    EXECUTE PROCEDURE <schema>.f_<tableName>_audit(); 
